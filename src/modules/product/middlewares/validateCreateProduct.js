...
/**
 * validateCreateProduct - Middleware responsável por validar os dados de criação de um produto.
 * 
...
const validateCreateProduct = (req, res, next) => {
  try {
    // Busca os dados do corpo da requisição e valida utilizando o schema do ProductModel
    ...
    if (err.name === "ZodError") {
      ...
      // Uma resposta de erro é lançada utilizando o AppError, indicando que houve um erro na criação do produto
